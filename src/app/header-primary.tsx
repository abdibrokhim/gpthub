      ...
      <nav className="w-full pt-4">
        <div className="navbar w-full relative !h-16 border-b-[1px] border-gray-700 px-8 md:px-0">
          <div className="flex justify-between items-center m-auto w-full md:w-4/5 2xl:w-3/5 relative">
            ...
            <div className="flex items-center gap-4">
              <a className="cta-top flex items-center rounded-md hover:opacity-80 active:opacity-60 active:scale-95 transition-all text-white text-[14px] px-4 h-[40px] shrink-0 grow-0 btn hover:opacity-80 !bg-blue-800 !text-white !bg-none !text-[14px] px-4 !h-[44px]" href="/showcase">
                <p className="whitespace-nowrap">Community Showcase</p>
              </a>
