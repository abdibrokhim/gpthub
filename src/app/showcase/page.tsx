...
{ 
  ...
  function Card({image, title, description, creator, demoUrl} : {image: any, title: string, description: string, creator: string, demoUrl: string}) {
    return (
      <div className="boxed bg-white p-6 shadow-md flex flex-col gap-4">
      ...
      <div className="flex flex-row flex-grow justify-center gap-4">
        ...
        {/* <button className="cta-top flex text-center justify-center items-center rounded-md hover:opacity-80 active:opacity-60 active:scale-95 transition-all text-white text-[14px] px-4 h-[40px] shrink-0 grow-0 btn hover:opacity-80 !bg-gray-800 !text-white !bg-none !text-[14px] px-4 !h-[44px]">
          <a className="" href="/submit-gpt">
            <div className='whitespace-nowrap'>Sponsor</div> 
          </a>
        </button> */}
        {/* <button className="cta-top flex text-center justify-center items-center rounded-md hover:opacity-80 active:opacity-60 active:scale-95 transition-all text-white text-[14px] px-4 h-[40px] shrink-0 grow-0 btn hover:opacity-80 !bg-green-800 !text-white !bg-none !text-[14px] px-4 !h-[44px]">
          <a className="" href="/submit-gpt">
            <div className='whitespace-nowrap'>Try it</div> 
          </a>
        </button> */}
      </div>
    </div>
